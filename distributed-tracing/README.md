...
# Azure functions samples in Java - Distributed tracing

This repository contains samples which show the usage of [Azure Functions](https://docs.microsoft.com/en-us/azure/azure-functions/) in Java using durable functions.
...
- Update the Application settings in Azure portal with the required parameters as below
  ...
  - Application insights specific [settings](https://learn.microsoft.com/en-us/azure/azure-monitor/app/monitor-functions)
